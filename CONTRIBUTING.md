...
Welcome to `pygarden` contributor's guide.
...
If you experience bugs or general issues with `pygarden`, please have a look
...
You can help improve `pygarden` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`pygarden` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `pygarden`'s files. While this mechanism can
...
```
conda create -n pygarden python=3 six virtualenv pytest pytest-cov
conda activate pygarden
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/pygarden.git
   cd pygarden
   ```
...
5. Install [pre-commit]:
   ...
   `pygarden` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/pygarden
[issue tracker]: https://github.com/<USERNAME>/pygarden/issues
